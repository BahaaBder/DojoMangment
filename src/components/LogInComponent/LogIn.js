...
const LogIn = inject("LogInStore","ScheduleStore")(observer((props) => {
      ...
      <Modal className="modal" show={show} onHide={handleClose}>
        <Modal.Header closeButton>
          ...
          <Modal.Title className="coach-info">
            new here?{" "}
            <Link className="pass" to="/Register">Create Acount</Link>
          </Modal.Title>
        </Modal.Header>
        ...
        <Modal.Footer>
          <Link to="signIn">
            <Button className="btn" variant="secondary" onClick={sign}>sign in</Button></Link>
          <Alert variant="danger" show={error}>Check Your Inputs Again !</Alert>
          <Alert variant="success" show={passforget}>Relax and try to remember you'r password</Alert>
        </Modal.Footer>
      </Modal>
    );
  })
